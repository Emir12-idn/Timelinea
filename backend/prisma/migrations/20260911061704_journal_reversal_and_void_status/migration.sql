-- AlterEnum
ALTER TYPE "PurchaseInvoiceStatus" ADD VALUE 'void';

-- AlterEnum
ALTER TYPE "SalesInvoiceStatus" ADD VALUE 'void';

-- AlterTable
ALTER TABLE "journal_entries" ADD COLUMN     "reversal_of_id" INTEGER,

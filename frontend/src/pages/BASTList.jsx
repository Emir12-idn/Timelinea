                ...
                <td className="px-4 py-3 text-right">
                  {bastByInvoice.has(v.id) ? (
                    ...
                    <button
                      ...
                      className="rounded-md border border-blue-200 bg-blue-50 px-2.5 py-1 text-xs font-medium text-blue-800 hover:bg-blue-100 disabled:opacity-60"
                    >
              ...
              <tr key={b.id} className="border-b border-slate-100 last:border-0 hover:bg-blue-50/50">
                ...
                <td className="px-4 py-3 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-md bg-rose-500 px-2.5 py-1 text-xs font-medium text-white hover:bg-rose-600 disabled:opacity-60"
                  >

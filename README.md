...
- **Kunci project selesai**: "Tandai Project Selesai" mengunci sheet Tasks/Settings/Resources dengan Protection API bawaan Google Sheets — benar-benar tidak bisa diedit siapa pun (termasuk yang punya akses Editor ke file), bukan cuma peringatan. Cocok untuk beberapa project berbeda customer di Sheet terpisah: project yang sudah selesai dikunci permanen sampai dibuka lagi lewat "Buka Kunci Project"
